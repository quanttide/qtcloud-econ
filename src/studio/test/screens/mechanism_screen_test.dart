...
Mechanism _buildMechanism() => const Mechanism(
      ...
      rules: [
        Rule(id: 'r1', name: '市场化微型创业', description: '拉进池子自己找题'),
      ],
      objectives: [
        Objective(id: 'o1', name: '招到留得住的人', description: '宁缺毋滥'),
      ],
    );
...
void main() {
  group('MechanismScreen 列表页', () {
    testWidgets('从种子数据加载并显示机制卡片', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: Scaffold(body: MechanismScreen())));
